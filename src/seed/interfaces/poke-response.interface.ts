// To parse this data:
//
//   import { Convert, PokeResponse } from "./file";
//
//   const pokeResponse = Convert.toPokeResponse(json);
//
...
export class Convert {
    public static toPokeResponse(json: string): PokeResponse {
        return cast(JSON.parse(json), r("PokeResponse"));
    }

    public static pokeResponseToJson(value: PokeResponse): string {
        return JSON.stringify(uncast(value, r("PokeResponse")), null, 2);
    }
}
